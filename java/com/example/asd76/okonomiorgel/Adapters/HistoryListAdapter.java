...
public class HistoryListAdapter extends BaseAdapter{
    ...
    private ArrayList<PurchaseRecords> purchasehistoryArr;

    public HistoryListAdapter(ArrayList<PurchaseRecords> arr) {
        this.purchasehistoryArr = arr;
        Log.e("HistoryListAdapter", purchasehistoryArr.size()+"");
    ...
    public void sortItem(String sort){
        switch (sort){
            case "최신순":
                ...
                break;
            case "높은 가격순":
                Collections.sort(purchasehistoryArr, new Comparator<PurchaseRecords>() {
                    @Override
                    public int compare(PurchaseRecords o1, PurchaseRecords o2) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PurchaseRecords item = purchasehistoryArr.get(position);
        ...
        seller.setText(item.getUser_name());
