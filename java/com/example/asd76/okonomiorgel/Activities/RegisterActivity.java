...
import com.example.asd76.okonomiorgel.Response.RegisterInfo;
...
public class RegisterActivity extends FragmentActivity implements View.OnClickListener{
    ...
    public void checkDuplicateId(){
        ...
        final Call<CheckBoolean> response = service.duplicateCheck(id);
        response.enqueue(new Callback<CheckBoolean>() {
            ...
            public void onResponse(Call<CheckBoolean> call, Response<CheckBoolean> response) {
                if(response.isSuccessful() && response.body() != null){
                    ...
                    CheckBoolean checkBoolean = response.body();

                    if(!checkBoolean.getCheck())
    ...
    public void sendUserInfo(String id, String password, String email){
        final Call<RegisterInfo> response = service.signUp(id, email, password);
        response.enqueue(new Callback<RegisterInfo>() {
            @Override
